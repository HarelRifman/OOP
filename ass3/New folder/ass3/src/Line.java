...
public class Line {
    ...
    private boolean isPointOnLine(Point point) {
        ...
        double slopeSegment = (int) (100000 * topOfM / bottomOfM);
        double slopePointStart = (int) (100000 * (pointY - startY) / (pointX - startX));
        double slopePointEnd = (int) (100000 * (pointY - endY) / (pointX - endX));
        return slopeSegment == slopePointStart && slopeSegment == slopePointEnd;
    }
    /**
    ...
    public Point intersectionWith(Line other) {
        ...
        if (this.start.getX() != this.end.getX() && other.start.getX() != other.end.getX()) {
            ...
            if ((int) (100000 * m1) == (int) (100000 * m2)) {
                // Check if the lines are collinear
                if ((int) (100000 * b1) == (int) (100000 * b2)) {
