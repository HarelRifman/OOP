...
public class Line {
    ...
    public boolean isIntersecting(Line other1, Line other2) {
        return other1.isIntersecting(other2) && this.isIntersecting(other1) && this.isIntersecting(other2);
    }
     ...
     * Two line segments are considered equal if they have the same start and end points,
     * regardless of the order of the points.
     *
     * @param other The other line segment to compare against.
